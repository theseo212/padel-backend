...
from app.padelcity.models import Campionato, Torneo, GruppoPC, GruppoMembroPC, ClassificaVoce, UtentePC
...
def genera_pdf_classifica(db_pc: Session, campionato_id: int) -> bytes | None:
