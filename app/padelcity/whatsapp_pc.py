"""
Invio messaggi WhatsApp specifici di PadelCity.
...
cambiano solo i template SID (dedicati a PadelCity) e i testi di
...
from app.padelcity.config import (
    NOME_CIRCOLO, FIRMA_MESSAGGIO, TEMPLATE_PC_RIEPILOGO_ISCRIZIONE,
    TEMPLATE_PC_RICHIESTA_ISCRIZIONE, TEMPLATE_PC_SOLLECITO_ISCRIZIONE,
    TEMPLATE_PC_GRUPPO_ASSEGNATO, TEMPLATE_PC_SEI_RISERVA, TEMPLATE_PC_PROMOZIONE_RISERVA,
    TEMPLATE_PC_RICHIESTA_PUNTEGGIO, TEMPLATE_PC_SOLLECITO_PUNTEGGIO, TEMPLATE_PC_CLASSIFICA_AGGIORNATA,
    TEMPLATE_PC_TORNEO_ANNULLATO, TEMPLATE_PC_GRUPPO_INCOMPLETO, TEMPLATE_PC_SOSTITUZIONE_COMPAGNO,
    URL_BASE_BACKEND_PUBBLICO,
)


def invia_riepilogo_iscrizione_pc(numero_whatsapp: str, nome: str, giorni_leggibili: str,
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_RIEPILOGO_ISCRIZIONE, variabili,
                  etichetta_simulazione=" PADELCITY")
...
def invia_richiesta_iscrizione_torneo(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str,
    ...
    """
    url_risposta = f"{URL_BASE_BACKEND_PUBBLICO}/padelcity/rispondi/{token}"
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_RICHIESTA_ISCRIZIONE, variabili,
                  etichetta_simulazione=" PADELCITY - RICHIESTA ISCRIZIONE")
...
def invia_sollecito_iscrizione_torneo(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str,
    ...
    variabili = {"1": nome, "2": nome_torneo, "3": giorno_leggibile, "4": data_leggibile, "5": fascia_oraria, "6": nome_circolo, "7": token} if nome else None
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_SOLLECITO_ISCRIZIONE, variabili,
                  etichetta_simulazione=" PADELCITY - SOLLECITO ISCRIZIONE")
...
def invia_conferma_ricevuta_torneo(numero_whatsapp: str, confermato: bool, giorno_leggibile: str, data_leggibile: str) -> bool:
    ...
    return _invia(numero_whatsapp, testo, None, None, etichetta_simulazione=" PADELCITY - ACK BOTTONE")
...
def invia_gruppo_assegnato_torneo(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str,
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_GRUPPO_ASSEGNATO, variabili,
                  etichetta_simulazione=" PADELCITY - GRUPPO ASSEGNATO")
...
def invia_sei_riserva_torneo(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str, data_leggibile: str) -> bool:
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_SEI_RISERVA, variabili,
                  etichetta_simulazione=" PADELCITY - SEI RISERVA")
...
def invia_avviso_gruppo_incompleto(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str, data_leggibile: str) -> bool:
    ...
    variabili = {"1": nome, "2": nome_torneo, "3": giorno_leggibile, "4": data_leggibile} if nome else None
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_GRUPPO_INCOMPLETO, variabili,
                  etichetta_simulazione=" PADELCITY - GRUPPO INCOMPLETO")
...
def invia_proposta_promozione_riserva(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str,
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_PROMOZIONE_RISERVA, variabili,
                  etichetta_simulazione=" PADELCITY - PROPOSTA PROMOZIONE")
...
def invia_promozione_confermata(numero_whatsapp: str, nome: str, giorno_leggibile: str, data_leggibile: str,
    ...
    return _invia(numero_whatsapp, testo, None, None, etichetta_simulazione=" PADELCITY - PROMOZIONE CONFERMATA")
...
def invia_sostituzione_compagno(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str,
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_SOSTITUZIONE_COMPAGNO, variabili,
                  etichetta_simulazione=" PADELCITY - SOSTITUZIONE COMPAGNO")
...
def invia_notifica_admin_nessuna_riserva(nome_torneo: str, giorno_leggibile: str, data_leggibile: str, gruppo_numero: int,
    ...
    for numero in ADMIN_WHATSAPP_NUMERI:
        _invia(numero, testo, None, None, etichetta_simulazione=" PADELCITY - AVVISO ADMIN")
...
def invia_richiesta_punteggio_torneo(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str, data_leggibile: str) -> bool:
    ...
    variabili = {"1": nome, "2": nome_torneo, "3": giorno_leggibile, "4": data_leggibile} if nome else None
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_RICHIESTA_PUNTEGGIO, variabili,
                  etichetta_simulazione=" PADELCITY - RICHIESTA PUNTEGGIO")
...
def invia_sollecito_punteggio_torneo(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str, data_leggibile: str) -> bool:
    ...
    variabili = {"1": nome, "2": nome_torneo, "3": giorno_leggibile, "4": data_leggibile} if nome else None
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_SOLLECITO_PUNTEGGIO, variabili,
                  etichetta_simulazione=" PADELCITY - SOLLECITO PUNTEGGIO")
...
def invia_punteggio_non_capito(numero_whatsapp: str) -> bool:
    ...
    return _invia(numero_whatsapp, testo, None, None, etichetta_simulazione=" PADELCITY - PUNTEGGIO NON CAPITO")
...
def invia_punteggio_confermato(numero_whatsapp: str, punteggio: int) -> bool:
    ...
    return _invia(numero_whatsapp, testo, None, None, etichetta_simulazione=" PADELCITY - PUNTEGGIO CONFERMATO")
...
def invia_classifica_aggiornata(numero_whatsapp: str, nome: str, nome_campionato: str,
    ...
    """
    url_classifica = f"{URL_BASE_BACKEND_PUBBLICO}/padelcity/classifica/{campionato_id}"
    testo = (
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_CLASSIFICA_AGGIORNATA, variabili,
                  etichetta_simulazione=" PADELCITY - CLASSIFICA AGGIORNATA (link)")
...
def invia_torneo_annullato(numero_whatsapp: str, nome: str, nome_torneo: str, giorno_leggibile: str,
    ...
    return _invia(numero_whatsapp, testo, TEMPLATE_PC_TORNEO_ANNULLATO, variabili,
                  etichetta_simulazione=" PADELCITY - TORNEO ANNULLATO")
