...
TEMPLATE_AVVISO_MESSAGGIO_NON_GESTITO = os.getenv("TEMPLATE_AVVISO_MESSAGGIO_NON_GESTITO")
TEMPLATE_INVIO_MASSIVO = os.getenv("TEMPLATE_INVIO_MASSIVO")
TEMPLATE_RICHIESTA_CONFERMA_COMPAGNO = os.getenv("TEMPLATE_RICHIESTA_CONFERMA_COMPAGNO")
TEMPLATE_ESITO_RICHIESTA_COPPIA = os.getenv("TEMPLATE_ESITO_RICHIESTA_COPPIA")
...
TIMEOUT_CONFERMA_MINUTI = int(os.getenv("TIMEOUT_CONFERMA_MINUTI", "15"))
MINUTI_ATTESA_PARTITA_GIOCATA = int(os.getenv("MINUTI_ATTESA_PARTITA_GIOCATA", "10"))
